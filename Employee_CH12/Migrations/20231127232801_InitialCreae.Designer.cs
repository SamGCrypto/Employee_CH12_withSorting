...
namespace Employee_CH12.Migrations
{
    ...
    [Migration("20231127232801_InitialCreae")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Employee_CH12.Models.DepartmentLocation", b =>
                {
            ...
            modelBuilder.Entity("Employees_Ch12.Models.Benefits", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Employees_Ch12.Models.Department", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Employees_Ch12.Models.Employee", b =>
                {
                    b.Property<int>("ID")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Employees_Ch12.Models.Location", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Employee_CH12.Models.DepartmentLocation", b =>
                {
                    b.HasOne("Employees_Ch12.Models.Department", "Department")
                        .WithMany("DepartmentLocation")
                        .HasForeignKey("DepartmentID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Employees_Ch12.Models.Location", "Location")
            ...
            modelBuilder.Entity("Employees_Ch12.Models.Employee", b =>
                {
                    b.HasOne("Employees_Ch12.Models.Benefits", "Benefits")
                        .WithMany("Employees")
